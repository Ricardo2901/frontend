...
def capitulo1(proyecto):
    
    if proyecto.upper() == "EXTRACCIÓN DE MATERIAL PETREO":
        extraccion_material_petreo()
    elif proyecto.upper() == "FRACCIONAMIENTO URBANO":
        fraccionamiento_urbano()
    elif proyecto.upper() == 'FRACCIONAMIENTO CAMPESTRE':
        fraccionamiento_campestre()

"""
    ========================================================================================================================
        Si es un fraccionamiento urbano
    ========================================================================================================================
"""
def fraccionamiento_urbano():
    doc = Document()
    ...
    descripcionCapitulo11 = di11.add_run('Proyecto "Fraccionamiento Urbano", que para la identificación en este documento se referirá al proyecto como "tipo de material".')
    ...
    """
    doc.save("CAPITULO 1 DTU FRACCIONAMIENTO URBANO.docx")


"""
    ========================================================================================================================
        Si es un fraccionamiento campestre
    ========================================================================================================================
"""
def fraccionamiento_campestre():
    doc = Document()
    ...
    # Texto del Capitulo 1.1
    di11 = doc.add_paragraph()
    descripcionCapitulo11 = di11.add_run('Proyecto "Fraccionamiento Campestre __________", que para la identificación en este documento se referirá al proyecto como "tipo de material".')
    descripcionCapitulo11_format = di11.paragraph_format
    descripcionCapitulo11_format.space_after = Pt(0)
    descripcionCapitulo11_format.line_spacing = 1.5
        ...
        Nota: Para guardar los documentos tienen que ser gardados de dos formas:
            ...
            5. Una parte del documentos se tiene que editar con el encabezado y el pie de pagina, si se pueden editar, pero por consideracion del cliente, se debe editar manualmente
                ...
                -> Editar el pie de pagina.
                    * El pie de pagina debe tener el nombre del cliente
    """
    doc.save("CAPITULO 1 DTU FRACCIONAMIENTO CAMPESTRE.docx")


"""
    ========================================================================================================================
        Si es de Extraccion de Material Petreo
    ========================================================================================================================
"""
def extraccion_material_petreo():
    doc = Document()
    ...
    # Texto del Capitulo 1.1
    di11 = doc.add_paragraph()
    descripcionCapitulo11 = di11.add_run('Proyecto "Extracción de Material Pétreo _________", que para la identificación en este documento se referirá al proyecto como "materia petreó".')
    descripcionCapitulo11_format = di11.paragraph_format
    descripcionCapitulo11_format.space_after = Pt(0)
    descripcionCapitulo11_format.line_spacing = 1.5
